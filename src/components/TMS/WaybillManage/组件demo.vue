<template>
    <div id="vehicleDispatch">
        <div class="input">
            <el-form :model="inputData" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <div class="row ">
                    <el-form-item class="cell6" label="车辆状态" prop="resource">
                        <el-radio-group v-model="inputData.carStatus">
                            <el-radio label="全部"></el-radio>
                            <el-radio label="已完成"></el-radio>
                            <el-radio label="运输中"></el-radio>
                        </el-radio-group>
                    </el-form-item>
                    <el-form-item label="车辆服务区域" class="cell4" prop="region">
                        <el-select v-model="inputData.serviceArea" placeholder="车辆服务区域">
                ...
                <div class="row">
                    <el-form-item label="车辆规格" class="cell4" prop="region">
                        <el-select v-model="inputData.carStandard" placeholder="车辆服务区域">
                            <el-option label="区域一" value="shanghai"></el-option>
                            <el-option label="区域二" value="beijing"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="车牌号" class="cell5" prop="carPlate">
                ...
                <div class="row">
                    <el-form-item class="cell6" label="车辆签约状态" prop="resource">
                        <el-radio-group v-model="inputData.carContract">
                            <el-radio label="全部"></el-radio>
                    ...
                    <div class="cell4">
                        ...
                        <el-popover 
                            ...
                            <div slot="reference" class="name-wrapper">
                                ...
                                <el-button type="primary" :disabled='!detailShow' style="margin-left:2em" >选中</el-button>
